  ...
  return (
    <main className="min-h-screen bg-black text-[#aaaaaa] px-6 py-16">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-[#666666] text-sm mb-10">Conforme au RGPD – En vigueur au 1er mars 2026</p>
        ...
        <section className="mb-8">
          ...
          <div className="text-[#aaaaaa] leading-relaxed space-y-2">
            <p><strong className="text-[#aaaaaa]">Données de compte :</strong> adresse email, identifiant unique (via Supabase Auth).</p>
            <p><strong className="text-[#aaaaaa]">Données d&apos;utilisation :</strong> historique des recherches (métier, ville, nombre de résultats), horodatage.</p>
            <p><strong className="text-[#aaaaaa]">Données de facturation :</strong> gérées exclusivement par Stripe — nous ne stockons aucune donnée bancaire.</p>
            <p><strong className="text-[#aaaaaa]">Cookies :</strong> cookies de session nécessaires au fonctionnement de l&apos;authentification (pas de cookies publicitaires).</p>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-[#aaaaaa] border border-[#1a1a1a] rounded-[9px] overflow-hidden">
              <thead className="bg-[#0d0d0d] text-[#aaaaaa]">
                <tr>
        ...
        <section className="mb-8">
          ...
          <div className="text-[#aaaaaa] leading-relaxed space-y-2">
            <p><strong className="text-[#aaaaaa]">Supabase</strong> – Authentification et base de données (hébergé AWS eu-west)</p>
            <p><strong className="text-[#aaaaaa]">Stripe</strong> – Traitement des paiements</p>
            <p><strong className="text-[#aaaaaa]">Vercel</strong> – Hébergement de l&apos;application</p>
            <p><strong className="text-[#aaaaaa]">Google</strong> – API Places pour la génération de leads</p>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-[#aaaaaa] leading-relaxed mb-3">
          ...
          <p className="text-[#aaaaaa] leading-relaxed">
            ...
            <a
              ...
              className="text-[#E5000A] hover:underline"
              target="_blank"
